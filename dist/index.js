...
var ReCaptchaContext = createContext(null);
function ReCaptchaProvider({
  ...
  return /* @__PURE__ */ React.createElement(ReCaptchaContext.Provider, { value }, children);
}
...
function withReCaptcha(Component) {
  return function WithReCaptchaWrapper(props) {
    const { isLoaded, executeRecaptcha } = useReCaptcha();
    return /* @__PURE__ */ React.createElement(Component, { ...props, isLoaded, executeRecaptcha });
  };
}
export {
  ReCaptcha,
